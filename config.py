...
class Config:
    ...
    #Stream 
    STREAM_URL=os.environ.get("STARTUP_STREAM", "https://www.youtube.com/watch?v=m-el0pQLQE4")
   
    #Database
    DATABASE_URI=os.environ.get("DATABASE_URI", None)
    DATABASE_NAME=os.environ.get("DATABASE_NAME", "greenplayer")
...
"""
    SCHEDULER_HELP="""
__greenplayer allows you to schedule a stream. 
...
"""
    RECORDER_HELP="""
__With greenplayer you can easily record all your video chats.
...
⚠️ If you start a recording with vcplayer, make sure you stop the same with greenplayer.
...
"""
    ...
    ADMIN_HELP="""
__greenplayer allows to control admins, that is you can add admins and remove them easily.
...
"""
    ...
    MISC_HELP="""
Command: **/export**
__greenplayer allows you to export your current playlist for future use.__
...
4. `SESSION_STRING` : __Generate From here [StringGenerator]__
