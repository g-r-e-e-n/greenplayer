...
![GitHub Repo stars](https://img.shields.io/github/stars/g-r-e-e-n/greenplayer?color=blue&style=flat)
![GitHub issues](https://img.shields.io/github/issues/g-r-e-e-n/greenplayer)
![GitHub pull requests](https://img.shields.io/github/issues-pr/g-r-e-e-n/greenplayer)
![GitHub contributors](https://img.shields.io/github/contributors/g-r-e-e-n/greenplayer?style=flat)
![GitHub forks](https://img.shields.io/github/forks/g-r-e-e-n/greenplayer?style=flat)
...
4. `SESSION_STRING` : Generate From string generator
...
## Deploy to Railway
<p><a href=https://github.com/g-r-e-e-n/greenplayer/issues/7> <img src="https://img.shields.io/badge/Deploy%20To%20Railway-blueviolet?style=for-the-badge&logo=railway" width="200""/></a></p>

 
## Deploy to VPS

```sh
git clone https://github.com/g-r-e-e-n/greenplayer
cd greenplayer
